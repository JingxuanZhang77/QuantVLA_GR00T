...
export GR00T_DUQUANT_ROW_ROT=none     # Output rotation with restore
export GR00T_DUQUANT_ACT_PCT=100
export GR00T_DUQUANT_CALIB_STEPS=32      # Conservative calibration
export GR00T_DUQUANT_LS=0.5              # Increased smoothing for stability

# Pack directory for caching quantization metadata
export GR00T_DUQUANT_PACKDIR="/home/jz97/VLM_REPO/Isaac-GR00T/smoothquant_packed_fullllmanddit_w4a8_long"
